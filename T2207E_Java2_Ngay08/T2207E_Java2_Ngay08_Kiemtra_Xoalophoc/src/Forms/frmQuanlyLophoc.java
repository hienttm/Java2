...
public class frmQuanlyLophoc extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnQuanlySinhvien, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        else
        {
            ...
            //kiểm tra bảng sinh viên có mã lớp này chưa?
            tbSinhvien bangSinhvien = new tbSinhvien();
            int kiemtralop = bangSinhvien.KiemtraLophoc(malop);
            if(kiemtralop==0)//nếu không có mã lớp trong bảng sinh viên
            {
                tbLophoc bangLophoc = new tbLophoc();
                int ketqua = bangLophoc.XoaLophoc(malop);
                if(ketqua>0)
                {
            ...
            else if(kiemtralop<0)
                JOptionPane.showMessageDialog(this, "Lỗi CSDL");
            else //kiemtralop>0
                JOptionPane.showMessageDialog(this, "Đã có sinh viên mã lớp này nên không được xóa");
        }        
