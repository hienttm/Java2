...
public class frmSuaSV extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        cbLophoc.getModel().setSelectedItem(this.sinhvien.tenlop);
    ...
    private void btDongYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDongYActionPerformed
        ...
        if(i<=0){
            ...
            //lấy đối tượng lớp học từ dòng chọn trên JComboBox
            lh = (clsLophoc) cbLophoc.getModel().getSelectedItem();
        }
        //tạo đối tượng sinh viên và thêm vào bảng tbSinhvien
        clsSinhvien sv = new clsSinhvien(this.sinhvien.id,masv,hoten,gioitinh,
                                diachi,lh.getMalop(),lh.getTenlop());
        tbSinhvien bangSinhvien = new tbSinhvien();
        int kq = bangSinhvien.SuaSinhvien(sv);
        if(kq>0)
        {
