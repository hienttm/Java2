...
public class Database {
    ...
    public static String pass ="root"; //password của user "root" mặc định là trống
    public static String url = "jdbc:mysql://localhost:3306/T2207E_JAVA2?useUnicode=true&characterEncoding=utf8";
